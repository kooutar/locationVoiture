...
<body class="min-h-screen bg-gray-100">
    ...
    <div class="min-h-screen flex items-center justify-center bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&q=80'); background-color: rgba(0,0,0,0.5); background-blend-mode: overlay;">
        <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-md m-4">
            ...
            <form class="space-y-6" action="../traitement/registre.php" method="POST">
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Nom complet</label>
                        <input type="text" name="Nom" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Nom Complet">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="tel" name="tel" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Téléphone">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Confirmer le mot de passe</label>
                        <input type="date" name="dateNaissance" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="confirmer le mot de passe">
                    </div>
